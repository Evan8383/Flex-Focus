    ...
    return (
        <div className="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-800 dark:border-gray-700">
            <div className="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
                <Link to='/app/dashboard' className="flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800">
                ...
                <Link to='/app/exercises' className="flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800">
                    <button type="button" className="flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        <svg className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 512 512">
                ...
                <Link to='/app/workouts' className="flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800">
                    <button type="button" className="flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        <svg className="w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 256 256">
                ...
                <button onClick={handleLogout} type="button" className="flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                    <svg className="w-5 h-5 text-red-400 transition duration-75 dark:text-red-400 group-hover:text-red-500" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
